...
\newcommand{\blockbegin}[1]{
	\ifx\insertblocktitle\empty
		\begin{tcolorbox}[colback=white,colframe=#1,coltext=black,coltitle=white]
	\else
		\begin{tcolorbox}[colback=white,colframe=#1,coltext=black,coltitle=white,title=\insertblocktitle]
	\fi
}
...
\defbeamertemplate{block example end}{framed}[1][]{\end{tcolorbox}}
